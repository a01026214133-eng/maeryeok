...
export default async function handler(req, res) {
  ...
  if (cloudName) {
    ...
    // 5) 도메인 최하단
    const layers = [
      `w_800,h_800,c_fill,b_rgb:1a0e04`,

      // 상단 레이블
      `l_text:NanumGothic_22:%E2%9C%A6%20%EB%82%98%EC%9D%98%20%EC%9D%BC%EC%A3%BC%EB%8A%94%20%E2%9C%A6,co_rgb:DCAF50,g_north,y_160`,

      // 일주 이름 — 72px (4글자 기준 잘림 없음)
      `l_text:NanumGothic_72_bold:${clEnc(iljuName)},co_rgb:F5E0A0,g_center,y_0`,

      // 이름 (있을 때)
      ...(name ? [`l_text:NanumGothic_26:${clEnc(name + ' 님의 사주')},co_rgb:DCC882,g_south,y_140`] : []),

      // 도메인
      `l_text:NanumGothic_20:obsd-iljutest.co.kr,co_rgb:887040,g_south,y_80`,
